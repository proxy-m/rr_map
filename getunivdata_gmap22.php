...
//echo $sql.'<br>';
	...
	foreach ($rr as $row)
	{
		...
		//{
			...
			$infomap[$i].='<tr style="font-family:arial;background:'. $univ[$i]['R_Color4']. '"><td style="font-family:arial;width:50px;height:22px"><img alt="" src="'. $univ[$i]['R_Os']. '" style="font-family:arial;float:right"></td><td style="width:110px;height:30px"><span style="font-size:9pt">Research</span></td><td class="style6" style="width:98px;height:9px"><span style="font-size:9pt">'. $univ[$i]['O_RR']. '</td><td class="style6" style="width:98px;height:9px"><span style="font-size:9pt">'. $univ[$i]['O_RS']. '</span></td><td style="font-family:arial;text-align:center;background:#ffffff" rowspan="3"><span style="font-family:arial;font-size:10px"><span style="font-family:arial;color:#999999"><a href="https://roundranking.com/universities/'.$univ[$i]['nm_page'].'.html?sort=O&year='.($year+2009).'&subject='.$sb[$subj].'" target="_blank">View full university profile</a></span></span></td></tr>';
