...
function ponyfillNavigatorUserAgentData() {
  return new NavigatorUAData(navigator);
}
function polyfillNavigatorUserAgentData() {
  if (location.protocol === 'https:' && window.navigator && (!navigator.userAgentData || navigator.userAgentData.mobile === undefined)) {
...
window.ponyfillNavigatorUserAgentData = ponyfillNavigatorUserAgentData;
window.polyfillNavigatorUserAgentData = polyfillNavigatorUserAgentData;

})(window);

function ponyfillNavigatorUserAgentData () {
    return window.ponyfillNavigatorUserAgentData.bind(this)(...arguments);
};
function polyfillNavigatorUserAgentData () {
    return window.polyfillNavigatorUserAgentData.bind(this)(...arguments);
};

export {ponyfillNavigatorUserAgentData, polyfillNavigatorUserAgentData}
